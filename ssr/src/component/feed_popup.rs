            ...
            <div class="flex flex-row justify-center">
                <div class="flex relative flex-col justify-center w-9/12 sm:w-4/12">
                    ...
                    <Show when=move || is_pwa_download>
                        ...
                        <span class="p-1 px-2 pb-7 text-center text-white md:p-1 md:px-5 md:pb-7 lg:p-1 lg:px-7 lg:pb-7 lg:text-xl">
                            {body_text}
                        </span>
                        <div class="flex justify-center">
                            <div class="z-[60]">
                                <DownloadPwaLink download_pwa_text=download_pwa_text />
                            </div>
                        </div>
                    </Show>
                </div>
