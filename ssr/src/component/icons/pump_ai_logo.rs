...
#[component]
pub fn PumpAILogo(#[prop(optional)] classes: String, #[prop(optional)] animate: bool) -> impl IntoView {
    view! {
        <svg class=classes viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
