...
#[component]
pub fn NotificationIcon(#[prop(optional)] classes: String, #[prop(optional)] show_dot: bool) -> impl IntoView {
    view! {
			if show_dot {
        <svg class=classes viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <circle cx="26" cy="6" r="5" fill="#E2017B" stroke="black" stroke-width="2" />
        </svg>
			} else {
				<svg class=classes viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
