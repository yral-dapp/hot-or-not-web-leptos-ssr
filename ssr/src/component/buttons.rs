...
#[component]
pub fn SecondaryLinkButton(children: Children,
    href: String,
    #[prop(optional)] classes: String,
    #[prop(optional)] alt_style: Signal<bool>) -> impl IntoView {
    view! {
        <a
            href=href
            class=format!(
...
#[component]
pub fn SecondaryButton(children: Children, disabled: Signal<bool>, alt_style: Signal<bool>, classes: String, on_click: impl Fn() + 'static,) -> impl IntoView {
    let on_click = move |_| on_click();
    view! {
        <button
            disabled=disabled.get()
