...
pub static OFF_CHAIN_AGENT_URL: Lazy<Url> =
    Lazy::new(|| Url::parse("http://localhost:50052").unwrap());
pub static OFF_CHAIN_AGENT_GRPC_URL: Lazy<Url> =
    Lazy::new(|| Url::parse("http://localhost:50052").unwrap()); // pr-91-yral-dapp-off-chain-agent https://icp-off-chain-agent.fly.dev:443
...
pub const ML_FEED_GRPC_URL: &str = "http://localhost:50051";// "https://yral-ml-feed-server.fly.dev:443"; // "http://localhost:50052";//
pub const ML_FEED_URL: Lazy<Url> = Lazy::new(|| Url::parse("http://localhost:50051").unwrap());
