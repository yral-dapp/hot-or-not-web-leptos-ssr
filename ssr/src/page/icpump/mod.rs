    ...
    view! {
        ...
        >
            ...
            <div class="flex gap-4 justify-between items-center p-2">
                <ActionButton label="Send".to_string() href="#".to_string()>
                    <SendIcon classes="w-full h-full".to_string() />
                </ActionButton>
                <ActionButton label="Buy/Sell".to_string() href="#".to_string()>
                    <ArrowLeftRightIcon classes="w-full h-full".to_string() />
                </ActionButton>
                <ActionButton label="Airdrop".to_string() href="#".to_string()>
